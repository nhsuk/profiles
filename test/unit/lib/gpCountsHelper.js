const gpCountsHelper = require('../../../app/lib/gpCountsHelper');
...
describe('gp counts helper', () => {
  describe('gpsAvailable', () => {
    it('should return false missing gp counts', () => {
      const result = gpCountsHelper.gpsAvailable(undefined);
    ...
    it('should return false for zero male and female gp counts', () => {
      ...
      const result = gpCountsHelper.gpsAvailable(gpCounts);
  ...
  describe('getGpCountMessages', () => {
    it('should return \'GPs\' for more than one male or female gp', () => {
      ...
      const message = gpCountsHelper.getGpCountMessages(gpCounts);
